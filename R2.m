...
% R2: Reactor 2. Reactor intermedio. 

function [sys, X0]=R2(t,X,U,flag);

% ODE Implementation Model No4. 
% With hydrolisis of particulate

global k1 k2 k3 k4 umax1_2 ks1_2 umax2_2 ks2_2 ki2_2 V Pt RT F
...
mu1 = umax1_2*X(3)/(ks1_2+X(3));                % Materia orgánica DQO - Monod (1/d)
mu2 = umax2_2*X(4)/(ks2_2+X(4)+(X(4)^2)/ki2_2);   % Acidos grasos volátiles - Haldane (1/d)
